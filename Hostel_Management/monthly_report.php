...
@media print {
    ...
    /* Hide the sidebar, print button, and breadcrumbs */
    .sidebar, .button-container, .breadcrumb-item {
        display: none;
    }
}

/* Footer positioning for screen */
footer {
    position: relative; /* Keep footer in normal document flow */
    width: 100%;
}
...
<body>
    ...
    <div class="main-content">
        ...
        <section>
            <h2 style="margin-top:20px;">Monthly Meal Plan Report</h2>
            <div class="breadcrumbs">
                ...
                <a href="view_meal_plans.php" class="breadcrumb-item">
                    <i class="fas fa-utensils"></i> Back to Meal Plans
                </a>
                <span class="breadcrumb-separator">|</span>
                <a href="annual_report.php" class="breadcrumb-item">
            ...
            <?php else: ?>
                <p>No meal plans for this month.</p><br><br>
            <?php endif; ?>
