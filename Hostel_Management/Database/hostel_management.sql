...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 30, 2024 at 08:35 PM
...
(6, 'mlp', '2024-11-27', '', '200117802545', 23, 'mlp@gmail.com', '0742397719', 2, '2024-11-27 06:25:03', 'mlp', '$2y$10$d9/j1V52O/x.MdRgpA5kNeLgeEJNRLb/aBl0B7TZNwLLW5oaP2EzS', 'uploads/Screenshot (3).png', 'uploads/Screenshot (5).png'),
(7, 'zaq', '2024-11-27', '', '20036985478', 21, 'adeeshap486@gmail.com', '0123654788', 5, '2024-11-27 06:31:35', 'zaq', '$2y$10$./IggkZ78RRXwxNbuiLziO.y3zow/Qku..Lpg9PbFl7Gqeia/Bhzy', 'uploads/france-in-pictures-beautiful-places-to-photograph-eiffel-tower.jpg', 'uploads/class diagram mid viva.drawio.pdf'),
(13, 'mnb', '2024-11-27', '', '20054572902', 20, 'mnb@gmail.com', '0321654987', 2, '2024-11-27 07:02:18', 'mnb', '$2y$10$0f7Du1ygCAo/F7hM6V0SyeuUnf1Bsn1uT4TQiRchihHBl.5CWlWjy', 'uploads/4k-hd-best-for-desktop-wallpaper-thumb.jpg', 'uploads/104-cat__top_cat_wallpaper.jpg');
...
INSERT INTO `bill` (`bill_id`, `order_id`, `bill_amount`, `bill_date`, `bill_status`) VALUES
(1, 29, 1000.00, '2024-11-27', 'Pending'),
(2, 1, 1000.00, '2024-11-27', 'Pending'),
(3, 29, 1000.00, '2024-11-27', 'Pending'),
(4, 29, 1000.00, '2024-11-27', 'Pending'),
(5, 29, 1000.00, '2024-11-27', 'Pending'),
(6, 30, 500.00, '2024-11-27', 'Pending'),
(7, 30, 500.00, '2024-11-27', 'Pending'),
(8, 31, 800.00, '2024-11-27', 'Pending'),
(9, 33, 2500.00, '2024-11-27', 'Pending'),
(10, 34, 400.00, '2024-11-27', 'Pending'),
(11, 35, 3500.00, '2024-11-28', 'Pending'),
(12, 36, 3000.00, '2024-11-28', 'Pending'),
(13, 37, 1000.00, '2024-11-28', 'Pending'),
(14, 37, 2000.00, '2024-11-28', 'Pending');
...
(11, 21, NULL, '2024-11-28', '2024-12-02', 'pending_approval', '2024-11-28 10:25:56');
...
(8, 'abcd', 'New Hire', 'a@gmail.com', '0719148762', 1, '2024-11-28 08:26:53', '20021465896', '$2y$10$etcXaiAPnBwL8swBqV6Wr.4qk/E8.jh3rVNjDF83cElg6/hcH4U7O', 1, 20);
...
INSERT INTO `employee_attendance` (`emp_attendance_id`, `employee_id`) VALUES
(1, 1);

-- --------------------------------------------------------

--
-- Table structure for table `employee_daily_checkin`
--

CREATE TABLE `employee_daily_checkin` (
  `emp_attendance_id` int(11) NOT NULL,
  `daily_in_time` datetime NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Dumping data for table `employee_daily_checkin`
--

INSERT INTO `employee_daily_checkin` (`emp_attendance_id`, `daily_in_time`) VALUES
(1, '2024-11-28 13:45:00'),
(1, '2024-12-01 06:41:00');

-- --------------------------------------------------------

--
-- Table structure for table `employee_daily_checkout`
--

CREATE TABLE `employee_daily_checkout` (
  `emp_attendance_id` int(11) NOT NULL,
  `daily_out_time` datetime NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Dumping data for table `employee_daily_checkout`
--

INSERT INTO `employee_daily_checkout` (`emp_attendance_id`, `daily_out_time`) VALUES
(1, '2024-12-01 20:42:00');
...
(3, 'cook', 'hostel', 'Open', '2024-11-27 10:58:18');
...
(10, 'christmas Party', 'party', '2024-11-18', '2024-11-18', '14:25:00', 'church', 'event orgenizer');
...
(3, 'Kosala Athapaththu', 'pabasaramadumini58@gmail.com', '$2y$10$x.86x.qDDqLdTPOXWCNM/uOc7dyqVYEToNn0nXQmpzM3vwmMdp7jS', '0719148762', NULL, '2024-11-08 09:19:09'),
(4, 'zxcv', 'zxcv@gmail.com', '$2y$10$3HwyU0g7DSP/DR3Wos1BGOBqtkvjdpuakIp6ODJb.7SmJdQmG1KvS', '0123654987', NULL, '2024-11-24 05:14:45'),
(5, 'plm', 'plm@gmail.com', '$2y$10$WWyAk2wpUwkracY7sX9iZOCpSkt21Al8Osg4hLl9M4dfxQhD0XGGu', '0742397719', NULL, '2024-11-28 10:04:50');
...
(4, 'refrigerator', 'furniture', 1, 85000.00, '2024-11-27 17:05:36');
...
(6, 3, 'poiu', 'poiu@gmail.com', '0719148762', '2024-11-27 11:04:38', 'expeerience', 'approved'),
(7, 1, 'tharushi', 'tharushi@gmail.com', '0719148762', '2024-11-28 08:46:18', 'testing 123', 'rejected');
...
(6, 1, '2024-11-25', '2024-11-30', 'declined', 'For a wedding\r\n', '2024-11-25 08:36:26'),
(7, 8, '2024-11-30', '2024-12-07', 'declined', 'sick', '2024-11-28 08:49:47');
...
INSERT INTO `orderdetails` (`detail_id`, `order_id`, `order_amount`, `delivery_date`, `remarks`) VALUES
(1, 1, 500.00, '2024-11-30', 'Urgent delivery required'),
(2, 29, 0.00, '0000-00-00', NULL),
(3, 30, 0.00, '0000-00-00', NULL),
(4, 31, 0.00, '0000-00-00', NULL),
(5, 32, 0.00, '0000-00-00', NULL),
(6, 33, 0.00, '0000-00-00', NULL),
(7, 34, 0.00, '0000-00-00', NULL),
(8, 35, 0.00, '0000-00-00', NULL),
(9, 36, 0.00, '0000-00-00', NULL),
(10, 37, 0.00, '0000-00-00', NULL),
(11, 38, 0.00, '0000-00-00', NULL);
...
INSERT INTO `orderpayments` (`payment_id`, `order_id`, `payment_status`) VALUES
(1, 29, 'Pending'),
(2, 30, 'Pending'),
(3, 31, 'Pending'),
(4, 32, 'Pending'),
...
INSERT INTO `orders` (`order_id`, `supplier_id`, `item_name`, `quantity`, `order_date`, `status`, `approved_by`, `order_amount`, `delivery_date`, `remarks`, `bill_amount`) VALUES
(1, 1, 'vegitables', 2, '2024-10-12 17:18:30', 'requested', NULL, 0.00, NULL, NULL, 0.00),
(2, 4, 'refrigerator', 1, '2024-10-12 17:43:42', 'requested', NULL, 0.00, NULL, NULL, 0.00),
(5, 7, 'vegitables', 7, '2024-10-27 19:54:34', '', 'foodcity1', 0.00, NULL, NULL, 0.00),
(6, 7, 'Milk Powder 1Kg packets', 10, '2024-10-27 20:01:00', '', NULL, 0.00, NULL, NULL, 0.00),
(7, 2, 'Tea 5kg', 2, '2024-10-27 20:13:42', '', NULL, 0.00, NULL, NULL, 0.00),
(8, 2, 'mixed vegitables', 2, '2024-10-27 20:31:01', '', NULL, 0.00, NULL, NULL, 0.00),
(9, 2, 'spoons', 20, '2024-10-27 20:44:58', 'declined', NULL, 0.00, NULL, NULL, 0.00),
(10, 2, 'vegitables', 2, '2024-10-27 20:46:15', '', NULL, 0.00, NULL, NULL, 0.00),
(11, 7, 'spoons', 20, '2024-10-27 20:50:47', 'approved', NULL, 0.00, NULL, NULL, 0.00),
(12, 1, 'vegtables', 5, '2024-11-02 05:05:06', 'requested', NULL, 0.00, NULL, NULL, 0.00),
(13, 2, 'vegitables', 5, '2024-11-02 05:05:55', 'approved', NULL, 0.00, NULL, NULL, 0.00),
(14, 8, 'Gass Cooker', 2, '2024-11-03 10:10:35', 'requested', NULL, 0.00, NULL, NULL, 0.00),
(15, 7, 'a', 1, '2024-11-27 08:20:06', '', NULL, 0.00, NULL, NULL, 0.00),
(29, 7, 'a', 2, '2024-11-27 09:43:42', '', NULL, 0.00, NULL, NULL, 0.00),
(30, 7, 'spoons', 5, '2024-11-27 17:33:52', '', NULL, 0.00, NULL, NULL, 0.00),
(31, 2, 'vegitables', 5, '2024-11-27 17:43:16', '', NULL, 0.00, NULL, NULL, 0.00),
(32, 2, 'vegitables', 4, '2024-11-27 17:46:48', '', NULL, 0.00, NULL, NULL, 0.00),
(33, 2, 'Milk Powder 1Kg packets', 2, '2024-11-27 18:00:07', '', NULL, 0.00, NULL, NULL, 0.00),
(34, 2, 'Suger 2kg', 2, '2024-11-27 18:29:07', '', NULL, 0.00, NULL, NULL, 0.00),
(35, 2, 'rice 10kg', 1, '2024-11-27 18:45:25', 'approved', NULL, 0.00, NULL, NULL, 0.00),
(36, 2, 'D', 2, '2024-11-28 04:50:05', 'approved', NULL, 0.00, NULL, NULL, 0.00),
(37, 2, 'z', 2, '2024-11-28 05:42:27', 'approved', NULL, 0.00, NULL, NULL, 0.00),
(38, 2, 'X', 3, '2024-11-28 07:13:44', 'requested', NULL, 0.00, NULL, NULL, 0.00);
...
CREATE TABLE `orderstatus` (
  ...
  `order_id` int(11) NOT NULL,
  `supplier_acceptance` varchar(50) DEFAULT 'Pending'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `orderstatus` (`status_id`, `order_id`, `supplier_acceptance`) VALUES
(1, 29, 'Pending'),
(2, 30, 'Pending');
...
(1, 'Tharushi Nikethana', '20021465896', '2003-01-26', 'wsfrga@gmail.com', '0123654987', 5, 'active', '2024-10-09 20:10:50', '', '', NULL, NULL),
(3, 'rashmi', '20024598766', '2002-07-27', 'jgffjkyv@gmail.com', '0123657986', 5, 'active', '2024-10-09 20:13:25', '', '', NULL, NULL),
...
(13, 'W.rashmi', '200245698756', '0000-00-00', 'rashmi13@gmail.com', '0742397719', 1, 'active', '2024-10-24 18:09:05', 'rush123', '$2y$10$rjhkfmaOpOCD3TYVE4jmUedEFRgA6L03PPsO6SVINW2e.WD6cbUkC', 'WIN_20241105_15_53_31_Pro.jpg', NULL),
...
(20, 'asdfgh', '20020145656', '2002-08-28', 'aqtbx@gmail.com', '014786565565', 8, 'active', '2024-11-20 04:58:52', 'aqtbx', '$2y$10$Waprg3yXr8GU4qXFMxYcL.nAafZwoCcIIsieCTzrWXd80kyA2GCVW', 'uploads/WIN_20241105_15_53_31_Pro.jpg', 'uploads/G1.pdf'),
...
(22, 'mlp', '200117802545', '0000-00-00', 'mlp@gmail.com', '0742397719', 2, 'active', '2024-11-27 06:32:50', 'mlp', '$2y$10$N/JQpiFFGp5Y7lmL8FXr9.fKfbNBRN7hY.3PEa71E52d/qZChlB7.', 'uploads/Screenshot (8).png', 'uploads/Screenshot (9).png'),
(24, 'plm', '200117401121', '2001-06-22', 'plm@gmail.com', '014788552369', 2, 'active', '2024-11-27 07:49:08', 'plm', '$2y$10$iA2Rt9anicdO.1/MFbPRfu5f49aaCk.GSncUh9MPlZUKiM7DfSTC2', 'uploads/Screenshot (11).png', 'uploads/Screenshot (5).png'),
(25, 'asdfgh', '20020145656', '2024-11-27', 'adeeshap486@gmail.com', '104789532', 10, 'active', '2024-11-27 07:53:54', 'vx', '$2y$10$JEu3ZQ7Hr9skr7V4Xn1Qw.n2lcy0c1RMaixNUdnk2Lt1nefhA5mde', 'Screenshot (6).png', 'uploads/EER mid viva.drawio.pdf'),
(26, 'plmi', '1234567890', '2024-11-27', 'kosalaathapaththu1234@gmail.com', '014788552369', 2, 'active', '2024-11-27 08:01:09', 'plmi', '$2y$10$Ugq8V3/eFpqdMDCf8Ym3kuE4U64OPo2PM9ZzFvsUgBlrE4X9necEO', 'uploads/Screenshot (3).png', 'uploads/Screenshot (4).png'),
(27, 'poi', '20019874563', '0000-00-00', 'poi@gmail.com', '0742397719', 2, 'active', '2024-11-28 09:56:56', 'poi', '$2y$10$z5uNNvEptnVWBgYhKgR/v.UiULGAfO.JzGHl.TZeaP3WpXd1eSJui', 'uploads/Screenshot 2024-09-09 105409.png', 'uploads/Screenshot 2024-10-12 000925.png');
...
(10, '7', 4, 'available', '2024-11-27 07:28:26');
...
(2, 'Cargils', 'food', '0700000022', '2024-10-12 08:45:26', 'cargils', '$2y$10$t1ginWzIv5sJ19mkb8v.OergzAHmqvHiCm.p0tUWpz5Qyp6A6qZgi'),
...
(9, 'Keels', 'food', '0700000000', '2024-11-28 05:17:26', 'keels_67483c2e93e5f', NULL);
...
--
-- Indexes for table `employee_daily_checkin`
--
ALTER TABLE `employee_daily_checkin`
  ADD KEY `emp_attendance_id` (`emp_attendance_id`);

--
-- Indexes for table `employee_daily_checkout`
--
ALTER TABLE `employee_daily_checkout`
  ADD KEY `emp_attendance_id` (`emp_attendance_id`);
...
--
ALTER TABLE `employee_attendance`
  MODIFY `emp_attendance_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
-- Constraints for table `employee_daily_checkin`
--
ALTER TABLE `employee_daily_checkin`
  ADD CONSTRAINT `employee_daily_checkin_ibfk_1` FOREIGN KEY (`emp_attendance_id`) REFERENCES `employee_attendance` (`emp_attendance_id`);

--
-- Constraints for table `employee_daily_checkout`
--
ALTER TABLE `employee_daily_checkout`
  ADD CONSTRAINT `employee_daily_checkout_ibfk_1` FOREIGN KEY (`emp_attendance_id`) REFERENCES `employee_attendance` (`emp_attendance_id`);
...
--
ALTER TABLE `orderpayments`
  ADD CONSTRAINT `orderpayments_ibfk_1` FOREIGN KEY (`order_id`) REFERENCES `orders` (`order_id`) ON DELETE CASCADE;
...
--
ALTER TABLE `orderstatus`
  ADD CONSTRAINT `orderstatus_ibfk_1` FOREIGN KEY (`order_id`) REFERENCES `orders` (`order_id`) ON DELETE CASCADE;
