...
<head>
    ...
    <title>Guest Dashboard - Salvation Army Girls Hostel</title>
...
<div><center><h3 styles="margin-bottom:20px;">Salvation Army <br>Girl's Hostel</h3></center>
        ...
        <main class="main-content">
            ...
            <div class="dashboard-grid">
                ...
                <div class="card room-vacancy">
                    <div class="card-header">
                        <i class="fas fa-door-open"></i>
                        <h3>Room Vacancy</h3>
                    </div>
                    <div class="card-content">
                        <p>Check available rooms and apply for accommodation</p>
                        <div class="card-actions">
                            <a href="view_room_vacancy.php" class="btn btn-primary">View Rooms</a>
                            <a href="register.php" class="btn btn-secondary">Apply Now</a>
                        </div>
                    </div>
                </div>

                <div class="card resident-rules">
                    <div class="card-header">
                        <i class="fas fa-book"></i>
                        <h3>Resident Rules</h3>
                    </div>
                    <div class="card-content">
                ...
                <div class="card job-vacancies">
                    <div class="card-header">
                        <i class="fas fa-briefcase"></i>
                        <h3>Job Vacancies</h3>
                    </div>
                    <div class="card-content">
                        <p>Explore current job openings and apply</p>
                        <div class="card-actions">
                            <a href="employee_vacancies.php" class="btn btn-primary">View Jobs</a>
                            <a href="apply_for_job.php" class="btn btn-secondary">Apply Job</a>
                        </div>
                    </div>
                </div>

                <div class="card employee-rules">
                    <div class="card-header">
                        <i class="fas fa-file-alt"></i>
                        <h3>Employee Rules</h3>
                    </div>
                    <div class="card-content">
